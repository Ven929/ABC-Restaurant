...
<body>
    <header>
        <div class="header-content">
            <h1>Check All Vendor Details</h1>
                 <nav>
                <ul>
            ...
            <tbody>
                <c:forEach var="user" items="${allUsers}">
                    <tr>
                        ...
                        <td>
                            <a href="Update.jsp?id=${user.id}&queryCategory=${user.queryCategory}&queryText=${user.queryText}&submittedAt=${user.submittedAt}&respondedAt=${user.respondedAt}&responseText=${user.responseText}">
